...
const stats = [
  { label: "Founded", value: "2020" },
  { label: "Learners Transformed & Certified", value: "12K+" },
...
export default function StatsSection() {
  return (
    <section className="bg-white py-20 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-64 h-64 bg-sky-100/50 rounded-full -translate-x-1/2 -translate-y-1/2 opacity-30"></div>
      <div className="absolute bottom-0 right-0 w-72 h-72 bg-yellow-100/50 rounded-full translate-x-1/4 translate-y-1/4 opacity-30"></div>
