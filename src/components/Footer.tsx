  ...
  return (
    <footer className="bg-[#0A1E3F] text-gray-300 py-12">
      <div className="container grid grid-cols-2 md:grid-cols-5 gap-8">
        ...
        {/* Why CodeWizardsHQ */}
        <div>
          <h4 className="text-white font-semibold mb-4">Why Young Scientist</h4>
          <ul className="space-y-2">
        ...
        {/* About CodeWizardsHQ */}
        <div>
          <h4 className="text-white font-semibold mb-4">About Young Scientist</h4>
          <ul className="space-y-2">
            <li>About Us</li>
            <li>Our Story</li>
            <li>Blog</li>
        ...
        <div className="flex flex-col items-start">
          <div className="mb-4">
            <img src="/images/logo/logo.png" alt="CodeWizardsHQ" className="h-12 w-auto mb-2 bg-slate-50 p-2 rounded-md shadow" />
            
          </div>
          <div className="space-y-1 text-sm">
            <p><span className="font-semibold text-white">Mailing Address:</span></p>
            <p>Kantipath,Jamal ,Kathmandu</p>
            <p>+977-015358003</p>
            <p>Sunday - Friday</p>
      ...
      <div className="mt-8 text-center text-gray-500 text-sm border-t border-gray-700 pt-4">
        <span>Privacy Policy</span> | <span>Billing Policy</span> | <span>Terms of Service</span> | © Copyright {new Date().getFullYear()} Young Scientist
      </div>
    </footer>
  );
}
